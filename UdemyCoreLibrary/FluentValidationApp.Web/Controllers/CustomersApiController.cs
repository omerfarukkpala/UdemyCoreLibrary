...
namespace FluentValidationApp.Web.Controllers
{
    ...
    public class CustomersApiController : ControllerBase
    {
        ...
        [Route("MappingOrnek")] // Bir method bir propertyye nasıl mapping yapılır.
        [HttpGet]
        ...
        public async Task<ActionResult<List<CustomerDto>>> GetCustomers()
        {
            ...
            //_mapper.Map<Customer>(new CustomerDto());
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
            ...
            if (!result.IsValid)
            {
                return BadRequest(result.Errors.Select(x => new { property = x.PropertyName, error = x.ErrorMessage })); // İsimsiz bir class döndük.
            }
